...
# param_estimates1 <- read.csv("output/param_estimates1.csv")
# param_estimates2 <- read.csv("output/param_estimates2.csv")
...
sensitivity_params_θt_μt <- simulate_disturbance(master_df=param_simulations_stable,
                                             param_number=9,  # θt 
                                             min_param_val=0,
                                             max_param_val=10,
                                             increase_val=0.5,
...
# 2) ATV trails
sensitivity_params_βa_αa <- simulate_disturbance(master_df=param_simulations_stable,
                                             param_number=2,  # αa
                                             min_param_val=0,
                                             max_param_val=10,
                                             increase_val=0.5,
...
ggsave(file = "surafce_plots_atv_nutrients_10000.svg", plot=atv_nutrient_surface_plots, width=12, height=6)
